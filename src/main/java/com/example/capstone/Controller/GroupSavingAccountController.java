...
public class GroupSavingAccountController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addGroupSavingAccount(@RequestBody @Valid GroupSavingAccount groupSavingAccount ) {
    ...
    public ResponseEntity<ApiResponse> updateGroupSavingAccount(@PathVariable Integer id, @RequestBody @Valid GroupSavingAccount groupSavingAccount ) {
